...
static func create_memory_wisp(n: String, lvl: int = 10) -> FighterData:
	...
	f.crit_chance = 34; f.crit_damage = 2; f.dodge_chance = 34
...
static func create_echo_sentinel(n: String, lvl: int = 10) -> FighterData:
	...
	f.health = EH.es(524, 597, 5, 8, lvl, 10); f.max_health = f.health
	f.mana = EH.es(7, 10, 1, 1, lvl, 10); f.max_mana = f.mana
	f.physical_attack = EH.es(59, 69, 2, 4, lvl, 10)
	f.physical_defense = EH.es(47, 54, 2, 3, lvl, 10)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 10)
	f.magic_defense = EH.es(29, 37, 1, 3, lvl, 10)
	f.speed = EH.es(35, 41, 1, 2, lvl, 10)
	f.crit_chance = 30; f.crit_damage = 2; f.dodge_chance = 31
...
static func create_thought_eater(n: String, lvl: int = 11) -> FighterData:
	...
	f.magic_attack = EH.es(86, 99, 2, 5, lvl, 11)
	f.magic_defense = EH.es(40, 47, 2, 3, lvl, 11)
	f.speed = EH.es(43, 49, 2, 3, lvl, 11)
	f.crit_chance = 35; f.crit_damage = 2; f.dodge_chance = 38
...
static func create_grief_shade(n: String, lvl: int = 11) -> FighterData:
	...
	f.crit_chance = 32; f.crit_damage = 2; f.dodge_chance = 32
...
static func create_sorrow_shade(n: String, lvl: int = 11) -> FighterData:
	...
	f.mana = EH.es(19, 22, 1, 2, lvl, 11); f.max_mana = f.mana
	f.physical_attack = EH.es(12, 16, 0, 2, lvl, 11)
	f.physical_defense = EH.es(21, 28, 1, 2, lvl, 11)
	f.magic_attack = EH.es(71, 82, 2, 4, lvl, 11)
	f.magic_defense = EH.es(34, 41, 2, 3, lvl, 11)
	f.speed = EH.es(40, 46, 2, 3, lvl, 11)
	f.crit_chance = 36; f.crit_damage = 2; f.dodge_chance = 31
...
static func create_hollow_watcher(n: String, lvl: int = 11) -> FighterData:
	...
	f.speed = EH.es(38, 44, 1, 3, lvl, 11)
...
static func create_mirror_self(n: String, lvl: int = 12) -> FighterData:
	...
	f.mana = EH.es(19, 22, 1, 2, lvl, 12); f.max_mana = f.mana
	f.physical_attack = EH.es(69, 80, 2, 4, lvl, 12)
	f.physical_defense = EH.es(34, 42, 2, 3, lvl, 12)
	f.magic_attack = EH.es(69, 80, 2, 4, lvl, 12)
	f.magic_defense = EH.es(34, 42, 2, 3, lvl, 12)
	f.speed = EH.es(42, 48, 2, 3, lvl, 12)
	f.crit_chance = 40; f.crit_damage = 3; f.dodge_chance = 34
...
static func create_void_weaver(n: String, lvl: int = 12) -> FighterData:
	...
	f.magic_attack = EH.es(72, 86, 3, 5, lvl, 12)
	f.magic_defense = EH.es(35, 42, 2, 4, lvl, 12)
	f.speed = EH.es(39, 45, 2, 3, lvl, 12)
	f.crit_chance = 42; f.crit_damage = 3; f.dodge_chance = 35
...
static func create_mnemonic_golem(n: String, lvl: int = 12) -> FighterData:
	...
	f.speed = EH.es(27, 33, 1, 2, lvl, 12)
	f.crit_chance = 34; f.crit_damage = 3; f.dodge_chance = 23
...
static func create_the_warden(n: String, lvl: int = 13) -> FighterData:
	...
	f.crit_chance = 40; f.crit_damage = 3; f.dodge_chance = 29
...
static func create_fractured_protector(n: String, lvl: int = 13) -> FighterData:
	...
	f.magic_attack = EH.es(78, 90, 2, 4, lvl, 13)
	f.magic_defense = EH.es(35, 41, 2, 3, lvl, 13)
	f.speed = EH.es(41, 47, 2, 3, lvl, 13)
	f.crit_chance = 41; f.crit_damage = 3; f.dodge_chance = 30
...
static func create_fading_wisp(n: String, lvl: int = 10) -> FighterData:
	...
	f.crit_chance = 42; f.crit_damage = 2; f.dodge_chance = 40
...
static func create_ward_construct(n: String, lvl: int = 12) -> FighterData:
	...
	f.health = EH.es(534, 616, 6, 9, lvl, 12); f.max_health = f.health
	f.mana = EH.es(7, 10, 1, 1, lvl, 12); f.max_mana = f.mana
	f.physical_attack = EH.es(114, 130, 3, 5, lvl, 12)
	f.physical_defense = EH.es(57, 66, 2, 4, lvl, 12)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 12)
	f.magic_defense = EH.es(46, 54, 2, 3, lvl, 12)
	f.speed = EH.es(34, 41, 1, 2, lvl, 12)
	f.crit_chance = 38; f.crit_damage = 3; f.dodge_chance = 32
...
static func create_null_phantom(n: String, lvl: int = 12) -> FighterData:
	...
	f.health = EH.es(403, 462, 4, 7, lvl, 12); f.max_health = f.health
	f.mana = EH.es(20, 23, 1, 2, lvl, 12); f.max_mana = f.mana
	f.physical_attack = EH.es(10, 14, 0, 2, lvl, 12)
	f.physical_defense = EH.es(29, 36, 1, 3, lvl, 12)
	f.magic_attack = EH.es(85, 98, 3, 5, lvl, 12)
	f.magic_defense = EH.es(51, 60, 2, 4, lvl, 12)
	f.speed = EH.es(43, 50, 2, 3, lvl, 12)
	f.crit_chance = 36; f.crit_damage = 2; f.dodge_chance = 35
...
static func create_threshold_echo(n: String, lvl: int = 12) -> FighterData:
	...
	f.physical_attack = EH.es(76, 88, 2, 4, lvl, 12)
	f.physical_defense = EH.es(35, 44, 2, 3, lvl, 12)
	f.magic_attack = EH.es(75, 87, 2, 4, lvl, 12)
	f.magic_defense = EH.es(35, 44, 2, 3, lvl, 12)
	f.speed = EH.es(44, 51, 2, 3, lvl, 12)
	f.crit_chance = 35; f.crit_damage = 3; f.dodge_chance = 37
...
static func create_ink_devourer(n: String, lvl: int = 11) -> FighterData:
	...
	f.magic_attack = EH.es(84, 97, 2, 5, lvl, 11)
	f.magic_defense = EH.es(32, 40, 2, 3, lvl, 11)
	f.speed = EH.es(46, 52, 2, 3, lvl, 11)
	f.crit_chance = 38; f.crit_damage = 2; f.dodge_chance = 39
...
static func create_silent_archivist(n: String, lvl: int = 11) -> FighterData:
	...
	f.physical_defense = EH.es(32, 40, 2, 3, lvl, 11)
	f.magic_attack = EH.es(78, 90, 3, 5, lvl, 11)
	f.magic_defense = EH.es(39, 46, 2, 3, lvl, 11)
	f.speed = EH.es(39, 45, 1, 3, lvl, 11)
	f.crit_chance = 34; f.crit_damage = 2; f.dodge_chance = 32
...
static func create_lost_record(n: String, lvl: int = 10) -> FighterData:
	...
	f.magic_attack = EH.es(80, 94, 2, 5, lvl, 10)
	f.magic_defense = EH.es(34, 42, 2, 3, lvl, 10)
	f.speed = EH.es(43, 50, 2, 3, lvl, 10)
	f.crit_chance = 34; f.crit_damage = 2; f.dodge_chance = 37
...
static func create_maw_codex(n: String, lvl: int = 11) -> FighterData:
	...
	f.physical_attack = EH.es(75, 87, 2, 4, lvl, 11)
	f.physical_defense = EH.es(30, 37, 2, 3, lvl, 11)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 11)
	f.magic_defense = EH.es(28, 35, 1, 3, lvl, 11)
	f.speed = EH.es(37, 43, 1, 3, lvl, 11)
	f.crit_chance = 37; f.crit_damage = 3; f.dodge_chance = 28
