...
const _DATA: Dictionary = {
	...
	"Grief Shade": { "s": [S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Hollow Watcher": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.CRIT, S.EVASION] },
	"Mirror Self": { "s": [S.CRIT, S.EVASION] },
	...
	"Maw Codex": { "s": [S.AOE, S.CRIT, S.EVASION] },
	...
	"Pipeline Warden": { "r": [R.TANK, R.FIGHTER], "s": [S.AOE, S.CRIT, S.EVASION] },
	"Maintenance Drone": { "s": [S.CRIT, S.EVASION], "d": D.MIXED },
	...
	# Story 3 - Acts IV-V
	# ==========================================================================
	"Cult Acolyte": { "s": [S.EVASION], "d": D.MIXED },
	...
	"Warding Shadow": { "s": [S.DEBUFFER], "d": D.MAGICAL },
