...
const _DATA: Dictionary = {
	...
	"Demon": { "s": [S.CRIT, S.EVASION], "d": D.MAGICAL },
	...
	"Fell Hound": { "s": [S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Sigil Wretch": { "r": [R.TANK, R.FIGHTER], "s": [S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Tunnel Lurker": { "r": [R.TANK, R.FIGHTER], "s": [S.DOT, S.AOE, S.CRIT, S.EVASION] },
	...
	"Void Sentinel": { "s": [S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Void Horror": { "r": [R.TANK, R.FIGHTER], "s": [S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Fractured Shadow": { "r": [R.DPS], "s": [S.CRIT, S.EVASION] },
	"Shadow Remnant": { "r": [R.TANK, R.FIGHTER], "s": [S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	...
	"Fading Wisp": { "r": [R.DPS], "s": [S.AOE, S.EVASION], "d": D.MAGICAL },
	...
	"Maintenance Drone": { "r": [R.DPS], "d": D.MIXED },
	"Resonance Node": { "r": [R.DPS], "s": [S.AOE], "d": D.MAGICAL },
	...
	"Cult Enforcer": { "r": [R.TANK, R.FIGHTER], "s": [S.DRAIN, S.AOE, S.DOT] },
	"Cult Hexer": { "r": [R.DPS], "s": [S.EVASION], "d": D.MAGICAL },
	"Thread Guard": { "r": [R.TANK, R.FIGHTER], "s": [S.AOE] },
	"Dream Hound": { "r": [R.DPS], "s": [S.AOE] },
	"Cult Ritualist": { "r": [R.DPS], "s": [S.AOE], "d": D.MAGICAL },
	"High Weaver": { "r": [R.DPS], "s": [S.EVASION], "d": D.MAGICAL },
	...
	# Story 3 - Path B
	# ==========================================================================
	"Cellar Sentinel": { "r": [R.TANK, R.FIGHTER], "s": [S.AOE] },
	...
	"Thread Ritualist": { "r": [R.DPS], "s": [S.AOE], "d": D.MAGICAL },
	...
	"Lira, the Threadmaster": { "s": [S.DRAIN, S.AOE], "d": D.MAGICAL, "t": T.BOSS },
	...
	# Story 3 - Path C
	# ==========================================================================
	"Abyssal Dreamer": { "r": [R.DPS], "s": [S.AOE], "d": D.MAGICAL },
