...
const _DATA: Dictionary = {
	...
	"Wisp": { "r": [R.DPS], "s": [S.DEBUFFER, S.GLASS_CANNON], "d": D.MAGICAL },
	...
	"Harlequin": { "r": [R.DPS], "s": [S.DEBUFFER, S.GLASS_CANNON], "d": D.MAGICAL },
	...
	"Shade": { "r": [R.DPS], "s": [S.DEBUFFER, S.GLASS_CANNON, S.EVASION], "d": D.MAGICAL },
	"Wraith": { "r": [R.DPS], "s": [S.DRAIN, S.EVASION], "d": D.MAGICAL },

	# ==========================================================================
	# Story 1 - Acts III-V
	# ==========================================================================
	"Royal Guard": { "r": [R.TANK, R.FIGHTER], "s": [S.BUFFER, S.CRIT, S.EVASION] },
	"Guard Sergeant": { "r": [R.SUPPORT, R.TANK, R.FIGHTER], "s": [S.BUFFER, S.CRIT, S.EVASION] },
	"Guard Archer": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION] },
	...
	"Corrupted Treant": { "r": [R.TANK, R.FIGHTER], "s": [S.BUFFER, S.AOE] },
	"Hellion": { "s": [S.DEBUFFER, S.GLASS_CANNON, S.CRIT] },
	"Fiendling": { "r": [R.DPS], "s": [S.DEBUFFER, S.CRIT], "d": D.MAGICAL },
	"Dragon": { "s": [S.DEBUFFER, S.AOE, S.CRIT], "d": D.MAGICAL, "t": T.LEADER },
	...
	"Sigil Wretch": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	...
	"Fractured Shadow": { "r": [R.DPS], "s": [S.DEBUFFER, S.CRIT, S.EVASION] },
	...
	"Cave Maw": { "s": [S.AOE] },
	"Vein Leech": { "r": [R.DPS], "s": [S.DEBUFFER, S.DRAIN, S.GLASS_CANNON] },
	"Stone Moth": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.GLASS_CANNON], "d": D.MAGICAL },

	# ==========================================================================
	# Story 2 - Act II
	# ==========================================================================
	"Driftwood Bandit": { "r": [R.DPS], "s": [S.DRAIN, S.CRIT, S.EVASION] },
	"Saltrunner Smuggler": { "r": [R.DPS], "s": [S.DEBUFFER, S.CRIT, S.EVASION] },
	...
	"Warped Hound": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION] },
	...
	"Corsair Hexer": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER], "d": D.MAGICAL },
	"Abyssal Lurker": { "r": [R.TANK, R.FIGHTER], "s": [S.DRAIN, S.AOE], "d": D.MAGICAL },
	"Stormwrack Raptor": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.EVASION] },
	...
	"Drowned Sailor": { "r": [R.DPS], "s": [S.DEBUFFER, S.DOT], "d": D.MIXED },
	"Depth Horror": { "s": [S.DEBUFFER, S.DRAIN, S.AOE], "d": D.MAGICAL },
	...
	"Grief Shade": { "r": [R.DPS], "s": [S.AOE], "d": D.MAGICAL },
	"Hollow Watcher": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER] },
	"Mirror Self": { "r": [R.DPS], "s": [S.CRIT], "d": D.MIXED },
	"Void Weaver": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE], "d": D.MAGICAL },
	...
	"Fading Wisp": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.EVASION], "d": D.MAGICAL },
	"Dim Guardian": { "r": [R.SUPPORT, R.TANK, R.FIGHTER], "s": [S.BUFFER] },
	"Ward Construct": { "r": [R.SUPPORT, R.TANK, R.FIGHTER], "s": [S.BUFFER] },
	"Null Phantom": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.EVASION], "d": D.MAGICAL },
	...
	"Lost Record": { "r": [R.DPS], "s": [S.DEBUFFER, S.DOT], "d": D.MAGICAL },
	"Maw Codex": { "r": [R.DPS], "s": [S.AOE] },
	"Shattered Frame": { "r": [R.DPS], "s": [S.DEBUFFER], "d": D.MAGICAL },
	"Sorrow Shade": { "r": [R.DPS], "s": [S.AOE], "d": D.MAGICAL },
	...
	"Oblivion Shade": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.GLASS_CANNON, S.EVASION], "d": D.MAGICAL },
	...
	# Story 2 - Path B
	# ==========================================================================
	"Fractured Scholar": { "r": [R.SUPPORT, R.FIGHTER], "s": [S.BUFFER, S.DRAIN] },
	"Archive Sentinel": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER] },
	"Pipeline Warden": { "r": [R.DPS], "s": [S.AOE] },
	"Maintenance Drone": { "r": [R.DPS], "s": [S.BUFFER], "d": D.MIXED },
	"Resonance Node": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE], "d": D.MAGICAL },
	"Eye's Fist": { "r": [R.SUPPORT, R.FIGHTER], "s": [S.BUFFER], "t": T.LEADER },
	"Null Sentinel": { "r": [R.SUPPORT, R.FIGHTER], "s": [S.BUFFER], "d": D.MAGICAL },
	"Overload Spark": { "r": [R.BURST], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MIXED },
	"Memory Torrent": { "r": [R.DPS], "s": [S.AOE, S.GLASS_CANNON], "d": D.MAGICAL },
	"Unleashed Recollection": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER] },
	"Rage Fragment": { "r": [R.BURST], "s": [S.AOE, S.GLASS_CANNON, S.CRIT, S.EVASION], "d": D.MIXED },
	"The Unblinking Eye": { "r": [R.DPS], "s": [S.DEBUFFER, S.DRAIN, S.AOE, S.CRIT], "d": D.MAGICAL, "t": T.BOSS },
	...
	"Nightmare Hound": { "s": [S.DEBUFFER] },
	"Dream Weaver": { "r": [R.SUPPORT, R.FIGHTER], "s": [S.BUFFER], "d": D.MAGICAL },
	"Hollow Echo": { "s": [S.DEBUFFER, S.DRAIN] },
	"Somnolent Serpent": { "r": [R.DPS], "s": [S.DEBUFFER, S.DOT, S.CRIT] },
	...
	# ==========================================================================
	"Thread Lurker": { "r": [R.DPS], "s": [S.DEBUFFER, S.CRIT, S.EVASION] },
	...
	"Gallery Shade": { "r": [R.DPS], "s": [S.DEBUFFER, S.CRIT] },
	"Shadow Pursuer": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MIXED },
	...
	"Cult Shade": { "r": [R.DPS], "s": [S.DEBUFFER], "d": D.MAGICAL },
	"Dream Warden": { "s": [S.DEBUFFER, S.CRIT], "d": D.MIXED },
	"Thought Leech": { "r": [R.SUPPORT], "s": [S.DEBUFFER, S.DRAIN, S.AOE], "d": D.MAGICAL },
	"Void Spinner": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE], "d": D.MAGICAL },
	"Void Phantom": { "r": [R.DPS], "d": D.MAGICAL },
	"Rift Mender": { "r": [R.SUPPORT], "s": [S.HEALER], "d": D.MAGICAL },
	"Sanctum Shade": { "r": [R.DPS], "s": [S.CRIT], "d": D.MAGICAL },
	...
	"Cult Hexer": { "r": [R.DPS], "s": [S.DEBUFFER, S.EVASION], "d": D.MAGICAL },
	"Thread Guard": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE] },
	"Dream Hound": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE] },
	"Cult Ritualist": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE], "d": D.MAGICAL },
	"High Weaver": { "r": [R.DPS], "s": [S.DEBUFFER, S.EVASION], "d": D.MAGICAL },
	...
	# Story 3 - Path B
	# ==========================================================================
	"Cellar Sentinel": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE] },
	"Bound Stalker": { "r": [R.DPS], "s": [S.DOT] },
	"Thread Disciple": { "s": [S.DRAIN], "d": D.MAGICAL },
	"Thread Warden": { "r": [R.TANK, R.FIGHTER] },
	"Tunnel Sentinel": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE] },
	"Thread Sniper": { "r": [R.DPS], "s": [S.DEBUFFER], "d": D.MAGICAL },
	"Pale Devotee": { "r": [R.SUPPORT], "s": [S.DEBUFFER, S.DOT, S.AOE], "d": D.MAGICAL },
	"Thread Ritualist": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE], "d": D.MAGICAL },
	...
	"Loom Tendril": { "r": [R.DPS], "s": [S.DEBUFFER, S.DOT, S.DRAIN, S.CRIT], "d": D.MAGICAL },
	"Cathedral Warden": { "r": [R.DPS], "s": [S.AOE, S.CRIT, S.EVASION], "d": D.MIXED },
	"Dream Binder": { "r": [R.DPS], "s": [S.DEBUFFER, S.DOT, S.AOE, S.EVASION], "d": D.MAGICAL },
	...
	"WeftStalker": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION] },
	"Loom Parasite": { "r": [R.DPS], "s": [S.DOT, S.DRAIN] },

	# ==========================================================================
	# Story 3 - Path C
	# ==========================================================================
	"Abyssal Dreamer": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE], "d": D.MAGICAL },
	"Thread Devourer": { "r": [R.DPS], "s": [S.DEBUFFER, S.DRAIN] },
	"Slumbering Colossus": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE] },
	"Dream Priest": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.CRIT], "d": D.MAGICAL },
	...
	"Memory Eater": { "r": [R.DPS], "s": [S.DEBUFFER, S.DRAIN, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Nightmare Sentinel": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE, S.CRIT] },
	"Anchor Chain": { "r": [R.SUPPORT], "s": [S.DEBUFFER], "d": D.MIXED },
	"The Ancient Threadmaster": { "r": [R.DPS], "s": [S.DEBUFFER, S.DRAIN, S.AOE, S.CRIT, S.EVASION], "d": D.MIXED, "t": T.BOSS },
	"Dream Shackle": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL, "t": T.UNDERLING },
