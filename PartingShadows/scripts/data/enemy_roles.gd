...
const _DATA: Dictionary = {
	...
	"Abyssal Lurker": { "r": [R.TANK, R.FIGHTER], "s": [S.DRAIN], "d": D.MAGICAL },
	...
	"Sorrow Shade": { "r": [R.DPS], "s": [], "d": D.MAGICAL },
	...
	"Maintenance Drone": { "r": [R.DPS], "s": [], "d": D.MIXED },
	...
	"Dream Warden": { "s": [S.DEBUFFER], "d": D.MAGICAL },
	...
	"Lira, the Threadmaster": { "s": [S.DEBUFFER, S.DRAIN, S.AOE], "d": D.MIXED, "t": T.BOSS },
	"Tattered Deception": { "s": [S.DEBUFFER], "d": D.MIXED, "t": T.UNDERLING },
