...
const _DATA: Dictionary = {
	...
	"Dark Knight": { "r": [R.SUPPORT, R.FIGHTER], "s": [S.BUFFER, S.AOE, S.CRIT], "t": T.LEADER },
	...
	"Cavern Snapper": { "r": [R.TANK, R.FIGHTER], "s": [S.CRIT] },
	...
	"Silt Lurker": { "s": [S.GLASS_CANNON, S.EVASION] },
	...
	"Void Weaver": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.CRIT], "d": D.MAGICAL },
	"Mnemonic Golem": { "r": [R.SUPPORT, R.TANK, R.FIGHTER], "s": [S.BUFFER, S.CRIT], "t": T.LEADER },
	...
	"Ink Devourer": { "r": [R.DPS], "s": [S.DRAIN, S.CRIT], "d": D.MAGICAL },
	"Silent Archivist": { "r": [R.SUPPORT], "s": [S.DEBUFFER], "d": D.MAGICAL },
	"Lost Record": { "s": [S.DEBUFFER, S.DOT, S.EVASION], "d": D.MAGICAL },
	"Maw Codex": { "s": [S.AOE, S.CRIT] },
	"Shattered Frame": { "r": [R.DPS], "s": [S.DEBUFFER], "d": D.MAGICAL },
	"Sorrow Shade": { "r": [R.DPS], "s": [S.CRIT], "d": D.MAGICAL },

	# ==========================================================================
	# Story 2 - Act IV
	# ==========================================================================
	"Pupil Leech": { "r": [R.TANK, R.FIGHTER], "s": [S.DOT, S.DRAIN], "d": D.MAGICAL },
	"Gaze Stalker": { "r": [R.BURST], "s": [S.DEBUFFER, S.CRIT], "d": D.MIXED },
	"Memory Harvester": { "r": [R.DPS], "s": [S.DRAIN, S.AOE, S.CRIT], "d": D.MAGICAL },
	"Oblivion Shade": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.GLASS_CANNON, S.CRIT], "d": D.MAGICAL },
	"Memory Reaper": { "r": [R.DPS], "s": [S.DOT, S.AOE, S.CRIT], "d": D.MAGICAL },
	...
	"Resonance Node": { "r": [R.DPS], "s": [S.DEBUFFER, S.AOE, S.CRIT], "d": D.MAGICAL },
	"Eye's Fist": { "r": [R.SUPPORT, R.FIGHTER], "s": [S.BUFFER, S.CRIT], "t": T.LEADER },
	"Null Sentinel": { "r": [R.SUPPORT, R.FIGHTER], "s": [S.BUFFER, S.CRIT], "d": D.MAGICAL },
	"Overload Spark": { "r": [R.BURST], "s": [S.DEBUFFER, S.AOE, S.CRIT], "d": D.MIXED },
	"Memory Torrent": { "r": [R.DPS], "s": [S.AOE, S.GLASS_CANNON, S.CRIT], "d": D.MAGICAL },
	"Unleashed Recollection": { "s": [S.DEBUFFER, S.CRIT] },
	"Rage Fragment": { "r": [R.BURST], "s": [S.AOE, S.GLASS_CANNON, S.CRIT], "d": D.MIXED },
	...
	"Market Watcher": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.CRIT], "t": T.LEADER },
	...
	# Story 3 - Act III
	# ==========================================================================
	"Lucid Phantom": { "s": [S.CRIT, S.EVASION], "d": D.MAGICAL },
	...
	# Story 3 - Acts IV-V
	# ==========================================================================
	"Cult Acolyte": { "s": [S.EVASION, S.CRIT], "d": D.MIXED },
	"Cult Enforcer": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.DRAIN, S.AOE, S.CRIT, S.EVASION] },
	"Cult Hexer": { "s": [S.DEBUFFER, S.EVASION, S.CRIT], "d": D.MAGICAL },
	"Thread Guard": { "s": [S.DEBUFFER, S.AOE, S.CRIT] },
	"Dream Hound": { "s": [S.DEBUFFER, S.AOE, S.CRIT] },
	"Cult Ritualist": { "s": [S.DEBUFFER, S.AOE, S.CRIT], "d": D.MAGICAL },
	"High Weaver": { "s": [S.DEBUFFER, S.CRIT, S.EVASION], "d": D.MAGICAL },
	...
	# Story 3 - Path B
	# ==========================================================================
	"Cellar Sentinel": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE, S.CRIT], "d": D.MIXED },
	"Bound Stalker": { "s": [S.DOT, S.CRIT, S.EVASION] },
	...
	"Pale Devotee": { "s": [S.DEBUFFER, S.DOT, S.AOE], "d": D.MAGICAL },
	"Thread Ritualist": { "s": [S.DEBUFFER, S.AOE, S.EVASION, S.CRIT], "d": D.MIXED },
	"Passage Guardian": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.EVASION, S.CRIT] },
	"Warding Shadow": { "s": [S.DEBUFFER, S.EVASION, S.CRIT], "d": D.MAGICAL },
	"Shadow Innkeeper": { "s": [S.DRAIN, S.CRIT, S.EVASION], "d": D.MIXED },
	"Astral Weaver": { "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Loom Tendril": { "s": [S.DEBUFFER, S.DOT, S.DRAIN, S.CRIT], "d": D.MAGICAL },
	"Cathedral Warden": { "s": [S.AOE, S.CRIT, S.EVASION], "d": D.MIXED },
	"Dream Binder": { "s": [S.DEBUFFER, S.DOT, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Thread Anchor": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MIXED },
	"Lira, the Threadmaster": { "s": [S.DEBUFFER, S.DRAIN, S.AOE, S.CRIT, S.EVASION], "d": D.MIXED, "t": T.BOSS },
	"Tattered Deception": { "s": [S.DEBUFFER, S.CRIT, S.EVASION], "d": D.MIXED, "t": T.UNDERLING },
	"Dream Bastion": { "r": [R.TANK, R.FIGHTER], "s": [S.AOE, S.CRIT], "d": D.MIXED, "t": T.UNDERLING },
	"WeftStalker": { "s": [S.DEBUFFER, S.AOE, S.CRIT], "d": D.MIXED },
	"Loom Parasite": { "s": [S.DOT, S.DRAIN] },

	# ==========================================================================
	# Story 3 - Path C
	# ==========================================================================
	"Abyssal Dreamer": { "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Thread Devourer": { "s": [S.DEBUFFER, S.DRAIN, S.CRIT, S.EVASION] },
	"Slumbering Colossus": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE, S.CRIT] },
	"Dream Priest": { "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	"Astral Enforcer": { "s": [S.CRIT, S.EVASION] },
	"Oneiric Hexer": { "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL },
	...
	"Anchor Chain": { "s": [S.DEBUFFER, S.CRIT, S.EVASION], "d": D.MIXED },
	...
	"Loom Heart": { "r": [R.TANK, R.FIGHTER], "s": [S.DEBUFFER, S.AOE, S.CRIT, S.EVASION], "d": D.MAGICAL, "t": T.UNDERLING },
}
