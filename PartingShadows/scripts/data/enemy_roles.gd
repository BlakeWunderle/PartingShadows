...
const _DATA: Dictionary = {
	...
	"Hound": { "s": [S.GLASS_CANNON], "d": D.MAGICAL },
	"Bandit": {},
	...
	"Stormwrack Raptor": { "s": [S.DEBUFFER, S.AOE, S.EVASION] },
	...
	"Drowned Sailor": { "s": [S.DEBUFFER, S.DOT], "d": D.MIXED },
	...
	"Fading Wisp": { "s": [S.DEBUFFER, S.AOE, S.EVASION], "d": D.MAGICAL },
	...
	"Lost Record": { "s": [S.DEBUFFER, S.DOT], "d": D.MAGICAL },
	...
	"Unleashed Recollection": { "s": [S.DEBUFFER] },
