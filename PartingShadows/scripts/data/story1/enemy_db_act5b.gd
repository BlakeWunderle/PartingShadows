...
static func create_ritual_conduit(n: String, lvl: int = 14) -> FighterData:
	...
	f.crit_chance = 33; f.crit_damage = 4; f.dodge_chance = 32
...
static func create_void_sentinel(n: String, lvl: int = 14) -> FighterData:
	...
	f.crit_chance = 40; f.crit_damage = 6; f.dodge_chance = 28
...
static func create_void_horror(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(455, 510, 6, 9, lvl, 15); f.max_health = f.health
	...
	f.magic_attack = EH.es(86, 98, 4, 6, lvl, 15)
	f.magic_defense = EH.es(50, 58, 3, 5, lvl, 15)
	f.speed = EH.es(47, 53, 2, 4, lvl, 15)
	f.crit_chance = 43; f.crit_damage = 5; f.dodge_chance = 34
...
static func create_fractured_shadow(n: String, lvl: int = 15) -> FighterData:
	...
	f.physical_attack = EH.es(82, 92, 3, 5, lvl, 15)
	f.physical_defense = EH.es(29, 36, 2, 3, lvl, 15)
	f.magic_attack = EH.es(14, 18, 0, 2, lvl, 15)
	f.magic_defense = EH.es(32, 40, 2, 3, lvl, 15)
	f.speed = EH.es(57, 65, 3, 5, lvl, 15)
	f.crit_chance = 43; f.crit_damage = 6; f.dodge_chance = 39
...
static func create_shadow_remnant(n: String, lvl: int = 15) -> FighterData:
	...
	f.magic_attack = EH.es(73, 82, 3, 5, lvl, 15)
	f.magic_defense = EH.es(46, 54, 2, 4, lvl, 15)
	f.speed = EH.es(50, 57, 2, 4, lvl, 15)
	f.crit_chance = 42; f.crit_damage = 5; f.dodge_chance = 32
...
static func create_stranger_undone(n: String, lvl: int = 15) -> FighterData:
	...
	f.physical_attack = EH.es(82, 93, 2, 4, lvl, 15)
	f.physical_defense = EH.es(52, 60, 2, 4, lvl, 15)
	f.magic_attack = EH.es(100, 112, 3, 6, lvl, 15)
	f.magic_defense = EH.es(54, 63, 2, 4, lvl, 15)
	f.speed = EH.es(79, 89, 3, 5, lvl, 15)
	f.crit_chance = 40; f.crit_damage = 7; f.dodge_chance = 31
