...
static func create_cellar_sentinel(n: String, lvl: int = 12) -> FighterData:
	...
	f.crit_chance = 42; f.crit_damage = 2; f.dodge_chance = 35
...
static func create_bound_stalker(n: String, lvl: int = 12) -> FighterData:
	...
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 12)
	f.magic_defense = EH.es(30, 36, 2, 3, lvl, 12)
	f.speed = EH.es(44, 50, 2, 3, lvl, 12)
	f.crit_chance = 44; f.crit_damage = 2; f.dodge_chance = 41
...
static func create_thread_disciple(n: String, lvl: int = 13) -> FighterData:
	...
	f.crit_chance = 36; f.crit_damage = 3; f.dodge_chance = 31
...
static func create_thread_warden(n: String, lvl: int = 13) -> FighterData:
	...
	f.physical_attack = EH.es(111, 127, 3, 5, lvl, 13)
	...
	f.crit_chance = 36; f.crit_damage = 3; f.dodge_chance = 26
...
static func create_tunnel_sentinel(n: String, lvl: int = 14) -> FighterData:
	...
	f.crit_chance = 41; f.crit_damage = 3; f.dodge_chance = 31
...
static func create_thread_sniper(n: String, lvl: int = 14) -> FighterData:
	...
	f.magic_attack = EH.es(101, 115, 3, 5, lvl, 14)
	f.magic_defense = EH.es(42, 50, 2, 4, lvl, 14)
	f.speed = EH.es(45, 51, 2, 3, lvl, 14)
	f.crit_chance = 39; f.crit_damage = 3; f.dodge_chance = 38
...
static func create_pale_devotee(n: String, lvl: int = 14) -> FighterData:
	...
	f.crit_chance = 35; f.crit_damage = 2; f.dodge_chance = 35
...
static func create_thread_ritualist(n: String, lvl: int = 14) -> FighterData:
	...
	f.speed = EH.es(45, 51, 2, 3, lvl, 14)
	f.crit_chance = 45; f.crit_damage = 3; f.dodge_chance = 44
...
static func create_passage_guardian(n: String, lvl: int = 14) -> FighterData:
	...
	f.mana = EH.es(8, 11, 1, 1, lvl, 14); f.max_mana = f.mana
	f.physical_attack = EH.es(113, 130, 3, 5, lvl, 14)
	f.physical_defense = EH.es(56, 64, 2, 4, lvl, 14)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 14)
	f.magic_defense = EH.es(46, 56, 2, 3, lvl, 14)
	f.speed = EH.es(39, 45, 2, 3, lvl, 14)
	f.crit_chance = 44; f.crit_damage = 3; f.dodge_chance = 39
...
static func create_warding_shadow(n: String, lvl: int = 14) -> FighterData:
	...
	f.magic_attack = EH.es(105, 119, 3, 5, lvl, 14)
	f.magic_defense = EH.es(44, 54, 2, 4, lvl, 14)
	f.speed = EH.es(45, 51, 2, 3, lvl, 14)
	f.crit_chance = 43; f.crit_damage = 2; f.dodge_chance = 44
...
static func create_shadow_innkeeper(n: String, lvl: int = 15) -> FighterData:
	...
	f.physical_attack = EH.es(88, 100, 3, 5, lvl, 15)
	f.physical_defense = EH.es(44, 52, 2, 4, lvl, 15)
	f.magic_attack = EH.es(87, 99, 3, 5, lvl, 15)
	f.magic_defense = EH.es(44, 52, 2, 4, lvl, 15)
	f.speed = EH.es(44, 50, 2, 3, lvl, 15)
	f.crit_chance = 56; f.crit_damage = 3; f.dodge_chance = 38
...
static func create_astral_weaver(n: String, lvl: int = 15) -> FighterData:
	...
	f.magic_attack = EH.es(105, 120, 3, 5, lvl, 15)
	f.magic_defense = EH.es(46, 54, 2, 4, lvl, 15)
	f.speed = EH.es(45, 51, 2, 3, lvl, 15)
	f.crit_chance = 54; f.crit_damage = 3; f.dodge_chance = 42
...
static func create_loom_tendril(n: String, lvl: int = 15) -> FighterData:
	...
	f.magic_attack = EH.es(97, 114, 3, 5, lvl, 15)
	f.magic_defense = EH.es(40, 48, 2, 4, lvl, 15)
	f.speed = EH.es(43, 49, 2, 3, lvl, 15)
	f.crit_chance = 49; f.crit_damage = 2; f.dodge_chance = 36
...
static func create_loom_parasite(n: String, lvl: int = 15) -> FighterData:
	...
	f.speed = EH.es(45, 51, 2, 3, lvl, 15)
	f.crit_chance = 37; f.crit_damage = 2; f.dodge_chance = 33
...
static func create_cathedral_warden(n: String, lvl: int = 16) -> FighterData:
	...
	f.crit_chance = 50; f.crit_damage = 3; f.dodge_chance = 44
...
static func create_dream_binder(n: String, lvl: int = 16) -> FighterData:
	...
	f.speed = EH.es(48, 54, 2, 3, lvl, 16)
	f.crit_chance = 49; f.crit_damage = 3; f.dodge_chance = 46
...
static func create_thread_anchor(n: String, lvl: int = 16) -> FighterData:
	...
	f.magic_attack = EH.es(109, 125, 3, 5, lvl, 16)
	f.magic_defense = EH.es(56, 65, 2, 4, lvl, 16)
	f.speed = EH.es(42, 49, 2, 3, lvl, 16)
	f.crit_chance = 45; f.crit_damage = 2; f.dodge_chance = 48
...
static func create_weft_stalker(n: String, lvl: int = 16) -> FighterData:
	...
	f.speed = EH.es(53, 59, 2, 3, lvl, 16)
	f.crit_chance = 41; f.crit_damage = 3; f.dodge_chance = 37
...
static func create_lira_threadmaster(n: String, lvl: int = 18) -> FighterData:
	...
	f.magic_attack = EH.es(131, 150, 4, 6, lvl, 18)
	f.magic_defense = EH.es(55, 63, 2, 4, lvl, 18)
	f.speed = EH.es(48, 54, 3, 4, lvl, 18)
	f.crit_chance = 43; f.crit_damage = 4; f.dodge_chance = 42
...
static func create_tattered_deception(n: String, lvl: int = 18) -> FighterData:
	...
	f.magic_attack = EH.es(115, 133, 3, 6, lvl, 18)
	f.magic_defense = EH.es(46, 55, 2, 4, lvl, 18)
	f.speed = EH.es(49, 55, 3, 4, lvl, 18)
	f.crit_chance = 41; f.crit_damage = 3; f.dodge_chance = 42
...
static func create_dream_bastion(n: String, lvl: int = 18) -> FighterData:
	...
	f.physical_attack = EH.es(128, 147, 3, 5, lvl, 18)
	f.physical_defense = EH.es(57, 65, 2, 4, lvl, 18)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 18)
	f.magic_defense = EH.es(48, 57, 2, 4, lvl, 18)
	f.speed = EH.es(39, 45, 2, 3, lvl, 18)
	f.crit_chance = 38; f.crit_damage = 3; f.dodge_chance = 29
