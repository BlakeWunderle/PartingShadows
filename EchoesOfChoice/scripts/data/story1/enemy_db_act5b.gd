...
static func create_sigil_colossus(n: String, lvl: int = 14) -> FighterData:
	...
	f.health = EH.es(480, 530, 8, 12, lvl, 14); f.max_health = f.health
	f.mana = EH.es(14, 18, 1, 2, lvl, 14); f.max_mana = f.mana
	f.physical_attack = EH.es(68, 76, 4, 6, lvl, 14)
	f.physical_defense = EH.es(42, 49, 3, 5, lvl, 14)
	f.magic_attack = EH.es(12, 16, 0, 2, lvl, 14)
	f.magic_defense = EH.es(34, 40, 2, 4, lvl, 14)
	f.speed = EH.es(28, 34, 1, 3, lvl, 14)
...
static func create_ritual_conduit(n: String, lvl: int = 14) -> FighterData:
	...
	f.health = EH.es(340, 385, 7, 10, lvl, 14); f.max_health = f.health
	f.mana = EH.es(24, 29, 2, 3, lvl, 14); f.max_mana = f.mana
	f.physical_attack = EH.es(12, 16, 0, 2, lvl, 14)
	f.physical_defense = EH.es(26, 32, 2, 3, lvl, 14)
	f.magic_attack = EH.es(58, 66, 4, 6, lvl, 14)
	f.magic_defense = EH.es(40, 47, 3, 5, lvl, 14)
	f.speed = EH.es(34, 40, 2, 4, lvl, 14)
...
static func create_void_sentinel(n: String, lvl: int = 14) -> FighterData:
	...
	f.health = EH.es(410, 458, 8, 11, lvl, 14); f.max_health = f.health
	f.mana = EH.es(18, 22, 2, 3, lvl, 14); f.max_mana = f.mana
	f.physical_attack = EH.es(48, 55, 3, 5, lvl, 14)
	f.physical_defense = EH.es(32, 38, 2, 4, lvl, 14)
	f.magic_attack = EH.es(50, 57, 3, 5, lvl, 14)
	f.magic_defense = EH.es(33, 39, 2, 4, lvl, 14)
	f.speed = EH.es(36, 42, 2, 4, lvl, 14)
...
static func create_void_horror(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(385, 430, 7, 10, lvl, 15); f.max_health = f.health
	f.mana = EH.es(26, 31, 2, 3, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(14, 18, 0, 2, lvl, 15)
	f.physical_defense = EH.es(28, 34, 2, 3, lvl, 15)
	f.magic_attack = EH.es(72, 82, 5, 7, lvl, 15)
	f.magic_defense = EH.es(42, 49, 3, 5, lvl, 15)
...
static func create_fractured_shadow(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(360, 405, 7, 10, lvl, 15); f.max_health = f.health
	f.mana = EH.es(14, 18, 1, 2, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(70, 79, 4, 6, lvl, 15)
	f.physical_defense = EH.es(24, 30, 2, 3, lvl, 15)
	f.magic_attack = EH.es(14, 18, 0, 2, lvl, 15)
	f.magic_defense = EH.es(28, 34, 2, 3, lvl, 15)
	f.speed = EH.es(46, 53, 3, 5, lvl, 15)
...
static func create_shadow_remnant(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(350, 395, 7, 10, lvl, 15); f.max_health = f.health
	f.mana = EH.es(22, 27, 2, 3, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(14, 18, 0, 2, lvl, 15)
	f.physical_defense = EH.es(30, 36, 2, 3, lvl, 15)
	f.magic_attack = EH.es(62, 71, 4, 6, lvl, 15)
	f.magic_defense = EH.es(38, 45, 2, 4, lvl, 15)
...
static func create_stranger_undone(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(880, 960, 14, 19, lvl, 15); f.max_health = f.health
	f.mana = EH.es(38, 44, 3, 4, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(60, 68, 3, 5, lvl, 15)
	f.physical_defense = EH.es(38, 44, 2, 4, lvl, 15)
	f.magic_attack = EH.es(68, 77, 4, 6, lvl, 15)
