...
static func create_harpy(n: String, lvl: int = 5) -> FighterData:
	...
	f.mana = EH.es(7, 9, 1, 2, lvl, 5); f.max_mana = f.mana
	f.physical_attack = EH.es(26, 31, 2, 4, lvl, 5)
...
static func create_witch(n: String, lvl: int = 4) -> FighterData:
	...
	f.physical_defense = EH.es(10, 14, 1, 2, lvl, 4)
	f.magic_attack = EH.es(28, 39, 3, 6, lvl, 4)
	f.magic_defense = EH.es(16, 24, 2, 4, lvl, 4)
...
static func create_wisp(n: String, lvl: int = 4) -> FighterData:
	...
	f.magic_defense = EH.es(12, 18, 1, 3, lvl, 4)
...
static func create_sprite(n: String, lvl: int = 4) -> FighterData:
	...
	f.physical_defense = EH.es(10, 15, 1, 2, lvl, 4)
	f.magic_attack = EH.es(13, 19, 1, 2, lvl, 4)
	f.magic_defense = EH.es(12, 18, 1, 2, lvl, 4)
...
static func create_siren(n: String, lvl: int = 4) -> FighterData:
	...
	f.magic_attack = EH.es(26, 36, 3, 6, lvl, 4)
	f.magic_defense = EH.es(16, 25, 2, 4, lvl, 4)
	f.speed = EH.es(24, 32, 1, 2, lvl, 3)
...
static func create_fire_wyrmling(n: String) -> FighterData:
	...
	f.health = EH.fixed(138, 155); f.max_health = f.health
	f.mana = EH.fixed(16, 18); f.max_mana = f.mana
	f.physical_attack = EH.fixed(15, 19); f.physical_defense = EH.fixed(15, 19)
	f.magic_attack = EH.fixed(26, 30); f.magic_defense = EH.fixed(20, 24)
...
static func create_frost_wyrmling(n: String) -> FighterData:
	...
	f.health = EH.fixed(138, 155); f.max_health = f.health
	f.mana = EH.fixed(13, 15); f.max_mana = f.mana
	f.physical_attack = EH.fixed(24, 28); f.physical_defense = EH.fixed(19, 23)
	f.magic_attack = EH.fixed(15, 19); f.magic_defense = EH.fixed(16, 20)
	f.speed = EH.fixed(30, 35)
	f.crit_chance = 17; f.crit_damage = 2; f.dodge_chance = 12
...
static func create_chanteuse(n: String) -> FighterData:
	...
	f.health = EH.fixed(99, 111); f.max_health = f.health
...
static func create_android(n: String) -> FighterData:
	...
	f.mana = EH.fixed(17, 20); f.max_mana = f.mana
	f.physical_attack = EH.fixed(23, 27); f.physical_defense = EH.fixed(23, 27)
...
static func create_machinist(n: String) -> FighterData:
	...
	f.physical_attack = EH.fixed(25, 29); f.physical_defense = EH.fixed(23, 27)
...
static func create_ironclad(n: String) -> FighterData:
	...
	f.mana = EH.fixed(13, 16); f.max_mana = f.mana
	f.physical_attack = EH.fixed(23, 26); f.physical_defense = EH.fixed(23, 27)
...
static func create_zombie(n: String, lvl: int = 6) -> FighterData:
	...
	f.magic_attack = EH.es(24, 31, 3, 5, lvl, 6)
	f.magic_defense = EH.es(22, 32, 2, 4, lvl, 6)
	f.speed = EH.es(28, 38, 1, 2, lvl, 6)
	f.crit_chance = 26; f.crit_damage = 3; f.dodge_chance = 23
...
static func create_ghoul(n: String, lvl: int = 6) -> FighterData:
	...
	f.magic_attack = EH.es(12, 17, 1, 2, lvl, 6)
	f.magic_defense = EH.es(15, 19, 1, 2, lvl, 6)
	f.speed = EH.es(28, 34, 2, 3, lvl, 6)
	f.crit_chance = 30; f.crit_damage = 3; f.dodge_chance = 24
...
static func create_wraith(n: String, lvl: int = 7) -> FighterData:
	...
	f.mana = EH.es(11, 13, 1, 2, lvl, 7); f.max_mana = f.mana
	...
	f.crit_chance = 23; f.crit_damage = 3; f.dodge_chance = 20
...
static func create_boneguard(n: String, lvl: int = 7) -> FighterData:
	...
	f.mana = EH.es(8, 11, 1, 2, lvl, 7); f.max_mana = f.mana
	...
	f.crit_chance = 23; f.crit_damage = 3; f.dodge_chance = 17
