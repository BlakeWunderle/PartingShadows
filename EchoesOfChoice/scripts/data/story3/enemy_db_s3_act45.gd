...
static func create_cult_acolyte(n: String, lvl: int = 10) -> FighterData:
	...
	f.health = _es(240, 276, 6, 9, lvl, 10); f.max_health = f.health
	f.mana = _es(17, 22, 1, 3, lvl, 10); f.max_mana = f.mana
	f.physical_attack = _es(22, 27, 1, 2, lvl, 10)
	f.physical_defense = _es(27, 32, 1, 2, lvl, 10)
	f.magic_attack = _es(38, 43, 2, 3, lvl, 10)
	f.magic_defense = _es(27, 32, 1, 2, lvl, 10)
	f.speed = _es(32, 37, 1, 2, lvl, 10)
...
static func create_cult_enforcer(n: String, lvl: int = 10) -> FighterData:
	...
	f.health = _es(288, 324, 7, 11, lvl, 10); f.max_health = f.health
	f.mana = _es(10, 14, 1, 2, lvl, 10); f.max_mana = f.mana
	f.physical_attack = _es(41, 46, 2, 3, lvl, 10)
	f.physical_defense = _es(34, 38, 2, 3, lvl, 10)
	f.magic_attack = _es(15, 19, 0, 2, lvl, 10)
	f.magic_defense = _es(29, 34, 1, 2, lvl, 10)
...
static func create_cult_hexer(n: String, lvl: int = 10) -> FighterData:
	...
	f.health = _es(234, 270, 5, 8, lvl, 10); f.max_health = f.health
	f.mana = _es(22, 26, 2, 3, lvl, 10); f.max_mana = f.mana
	f.physical_attack = _es(19, 24, 1, 2, lvl, 10)
	f.physical_defense = _es(24, 29, 1, 2, lvl, 10)
	f.magic_attack = _es(41, 46, 2, 3, lvl, 10)
	f.magic_defense = _es(29, 34, 1, 3, lvl, 10)
	f.speed = _es(32, 37, 1, 2, lvl, 10)
...
static func create_thread_guard(n: String, lvl: int = 11) -> FighterData:
	...
	f.health = _es(300, 342, 7, 11, lvl, 11); f.max_health = f.health
	f.mana = _es(14, 18, 1, 2, lvl, 11); f.max_mana = f.mana
	f.physical_attack = _es(43, 48, 2, 3, lvl, 11)
	f.physical_defense = _es(34, 38, 2, 3, lvl, 11)
	f.magic_attack = _es(19, 24, 1, 2, lvl, 11)
	f.magic_defense = _es(31, 36, 1, 3, lvl, 11)
	f.speed = _es(32, 37, 1, 2, lvl, 11)
	f.crit_chance = 11; f.crit_damage = 1; f.dodge_chance = 9
...
static func create_dream_hound(n: String, lvl: int = 11) -> FighterData:
	...
	f.health = _es(264, 300, 6, 9, lvl, 11); f.max_health = f.health
	f.mana = _es(12, 16, 1, 2, lvl, 11); f.max_mana = f.mana
	f.physical_attack = _es(41, 46, 2, 3, lvl, 11)
	f.physical_defense = _es(27, 31, 1, 2, lvl, 11)
	f.magic_attack = _es(17, 22, 1, 2, lvl, 11)
	f.magic_defense = _es(24, 29, 1, 2, lvl, 11)
...
static func create_cult_ritualist(n: String, lvl: int = 12) -> FighterData:
	...
	f.health = _es(294, 336, 6, 9, lvl, 12); f.max_health = f.health
	f.mana = _es(24, 28, 2, 3, lvl, 12); f.max_mana = f.mana
	f.physical_attack = _es(22, 27, 1, 2, lvl, 12)
	f.physical_defense = _es(31, 36, 1, 3, lvl, 12)
	f.magic_attack = _es(43, 48, 2, 3, lvl, 12)
	f.magic_defense = _es(34, 38, 2, 3, lvl, 12)
	f.speed = _es(32, 37, 1, 2, lvl, 12)
	f.crit_chance = 11; f.crit_damage = 1; f.dodge_chance = 9
...
static func create_high_weaver(n: String, lvl: int = 12) -> FighterData:
	...
	f.health = _es(312, 354, 6, 10, lvl, 12); f.max_health = f.health
	f.mana = _es(26, 30, 2, 4, lvl, 12); f.max_mana = f.mana
	f.physical_attack = _es(19, 24, 1, 2, lvl, 12)
	f.physical_defense = _es(29, 34, 1, 3, lvl, 12)
	f.magic_attack = _es(48, 53, 2, 4, lvl, 12)
	f.magic_defense = _es(34, 38, 2, 3, lvl, 12)
	f.speed = _es(34, 39, 1, 3, lvl, 12)
	f.crit_chance = 13; f.crit_damage = 1; f.dodge_chance = 11
...
static func create_shadow_fragment(n: String, lvl: int = 13) -> FighterData:
	...
	f.health = _es(220, 252, 5, 8, lvl, 13); f.max_health = f.health
	f.mana = _es(14, 18, 1, 3, lvl, 13); f.max_mana = f.mana
	f.physical_attack = _es(24, 29, 1, 3, lvl, 13)
	f.physical_defense = _es(26, 31, 1, 3, lvl, 13)
	f.magic_attack = _es(36, 41, 2, 3, lvl, 13)
	f.magic_defense = _es(30, 35, 1, 3, lvl, 13)
	f.speed = _es(34, 39, 2, 3, lvl, 13)
...
static func create_the_threadmaster(n: String, lvl: int = 13) -> FighterData:
	...
	f.health = _es(420, 480, 11, 16, lvl, 13); f.max_health = f.health
	f.mana = _es(32, 36, 3, 5, lvl, 13); f.max_mana = f.mana
	f.physical_attack = _es(48, 54, 2, 4, lvl, 13)
	f.physical_defense = _es(36, 41, 2, 3, lvl, 13)
	f.magic_attack = _es(53, 58, 3, 4, lvl, 13)
	f.magic_defense = _es(36, 41, 2, 3, lvl, 13)
