...
static func create_abyssal_dreamer(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(438, 505, 5, 8, lvl, 15); f.max_health = f.health
	...
	f.magic_attack = EH.es(87, 100, 3, 5, lvl, 15)
...
static func create_thread_devourer(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(477, 550, 5, 8, lvl, 15); f.max_health = f.health
	f.mana = EH.es(8, 11, 1, 1, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(89, 102, 3, 5, lvl, 15)
...
static func create_slumbering_colossus(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(572, 655, 6, 9, lvl, 15); f.max_health = f.health
	f.mana = EH.es(8, 11, 1, 1, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(92, 105, 3, 5, lvl, 15)
...
static func create_dream_priest(n: String, lvl: int = 16) -> FighterData:
	...
	f.health = EH.es(540, 621, 5, 8, lvl, 16); f.max_health = f.health
	...
	f.magic_attack = EH.es(102, 117, 3, 5, lvl, 16)
...
static func create_astral_enforcer(n: String, lvl: int = 16) -> FighterData:
	...
	f.health = EH.es(605, 691, 6, 9, lvl, 16); f.max_health = f.health
	f.mana = EH.es(8, 11, 1, 1, lvl, 16); f.max_mana = f.mana
	f.physical_attack = EH.es(106, 122, 3, 5, lvl, 16)
...
static func create_oneiric_hexer(n: String, lvl: int = 16) -> FighterData:
	...
	f.health = EH.es(475, 547, 5, 8, lvl, 16); f.max_health = f.health
...
static func create_ancient_threadmaster(n: String, lvl: int = 18) -> FighterData:
	...
	f.health = EH.es(798, 900, 8, 12, lvl, 18); f.max_health = f.health
	...
	f.magic_attack = EH.es(112, 129, 4, 6, lvl, 18)
...
static func create_dream_shackle(n: String, lvl: int = 18) -> FighterData:
	...
	f.health = EH.es(450, 517, 5, 8, lvl, 18); f.max_health = f.health
...
static func create_loom_heart(n: String, lvl: int = 18) -> FighterData:
	...
	f.health = EH.es(531, 611, 5, 8, lvl, 18); f.max_health = f.health
