...
static func create_abyssal_dreamer(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(419, 483, 5, 8, lvl, 15); f.max_health = f.health
	f.mana = EH.es(19, 23, 1, 2, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(10, 14, 0, 2, lvl, 15)
	f.physical_defense = EH.es(32, 40, 2, 3, lvl, 15)
	f.magic_attack = EH.es(85, 97, 3, 5, lvl, 15)
	f.magic_defense = EH.es(40, 47, 2, 4, lvl, 15)
...
static func create_thread_devourer(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(456, 525, 5, 8, lvl, 15); f.max_health = f.health
	f.mana = EH.es(8, 11, 1, 1, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(87, 99, 3, 5, lvl, 15)
	f.physical_defense = EH.es(38, 45, 2, 3, lvl, 15)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 15)
	f.magic_defense = EH.es(34, 40, 2, 3, lvl, 15)
	f.speed = EH.es(36, 42, 2, 3, lvl, 15)
...
static func create_slumbering_colossus(n: String, lvl: int = 15) -> FighterData:
	...
	f.health = EH.es(547, 625, 6, 9, lvl, 15); f.max_health = f.health
	f.mana = EH.es(8, 11, 1, 1, lvl, 15); f.max_mana = f.mana
	f.physical_attack = EH.es(90, 102, 3, 5, lvl, 15)
	f.physical_defense = EH.es(49, 56, 2, 4, lvl, 15)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 15)
	f.magic_defense = EH.es(41, 49, 2, 3, lvl, 15)
	f.speed = EH.es(22, 28, 1, 2, lvl, 15)
...
static func create_dream_priest(n: String, lvl: int = 16) -> FighterData:
	...
	f.health = EH.es(511, 588, 5, 8, lvl, 16); f.max_health = f.health
	f.mana = EH.es(20, 24, 1, 2, lvl, 16); f.max_mana = f.mana
	f.physical_attack = EH.es(10, 14, 0, 2, lvl, 16)
	f.physical_defense = EH.es(41, 49, 2, 4, lvl, 16)
	f.magic_attack = EH.es(98, 113, 3, 5, lvl, 16)
	f.magic_defense = EH.es(49, 57, 2, 4, lvl, 16)
...
static func create_astral_enforcer(n: String, lvl: int = 16) -> FighterData:
	...
	f.health = EH.es(573, 654, 6, 9, lvl, 16); f.max_health = f.health
	f.mana = EH.es(8, 11, 1, 1, lvl, 16); f.max_mana = f.mana
	f.physical_attack = EH.es(102, 118, 3, 5, lvl, 16)
	f.physical_defense = EH.es(51, 59, 2, 4, lvl, 16)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 16)
	f.magic_defense = EH.es(43, 51, 2, 3, lvl, 16)
...
static func create_oneiric_hexer(n: String, lvl: int = 16) -> FighterData:
	...
	f.health = EH.es(450, 517, 5, 8, lvl, 16); f.max_health = f.health
	f.mana = EH.es(19, 23, 1, 2, lvl, 16); f.max_mana = f.mana
	f.physical_attack = EH.es(10, 14, 0, 2, lvl, 16)
	f.physical_defense = EH.es(35, 43, 2, 3, lvl, 16)
	f.magic_attack = EH.es(99, 115, 3, 6, lvl, 16)
	f.magic_defense = EH.es(45, 53, 2, 4, lvl, 16)
...
static func create_memory_eater(n: String, lvl: int = 17) -> FighterData:
	...
	f.health = EH.es(530, 610, 5, 8, lvl, 17); f.max_health = f.health
	f.mana = EH.es(20, 24, 1, 2, lvl, 17); f.max_mana = f.mana
	f.physical_attack = EH.es(10, 14, 0, 2, lvl, 17)
	f.physical_defense = EH.es(40, 48, 2, 4, lvl, 17)
	f.magic_attack = EH.es(107, 123, 3, 6, lvl, 17)
	f.magic_defense = EH.es(50, 58, 2, 4, lvl, 17)
...
static func create_nightmare_sentinel(n: String, lvl: int = 17) -> FighterData:
	...
	f.health = EH.es(627, 718, 6, 9, lvl, 17); f.max_health = f.health
	f.mana = EH.es(11, 14, 1, 2, lvl, 17); f.max_mana = f.mana
	f.physical_attack = EH.es(108, 124, 3, 5, lvl, 17)
	f.physical_defense = EH.es(54, 62, 2, 4, lvl, 17)
	f.magic_attack = EH.es(8, 12, 0, 1, lvl, 17)
	f.magic_defense = EH.es(48, 56, 2, 3, lvl, 17)
...
static func create_anchor_chain(n: String, lvl: int = 17) -> FighterData:
	...
	f.health = EH.es(584, 670, 6, 9, lvl, 17); f.max_health = f.health
	f.mana = EH.es(11, 14, 1, 2, lvl, 17); f.max_mana = f.mana
	f.physical_attack = EH.es(94, 107, 3, 5, lvl, 17)
	f.physical_defense = EH.es(56, 64, 2, 4, lvl, 17)
	f.magic_attack = EH.es(94, 107, 3, 5, lvl, 17)
...
static func create_dream_shackle(n: String, lvl: int = 18) -> FighterData:
	...
	f.magic_attack = EH.es(98, 113, 3, 6, lvl, 18)
...
static func create_loom_heart(n: String, lvl: int = 18) -> FighterData:
	...
	f.health = EH.es(520, 598, 5, 8, lvl, 18); f.max_health = f.health
	f.mana = EH.es(20, 24, 2, 3, lvl, 18); f.max_mana = f.mana
	f.physical_attack = EH.es(10, 14, 0, 2, lvl, 18)
	f.physical_defense = EH.es(46, 54, 2, 4, lvl, 18)
	f.magic_attack = EH.es(90, 104, 3, 5, lvl, 18)
	f.magic_defense = EH.es(50, 58, 2, 4, lvl, 18)
