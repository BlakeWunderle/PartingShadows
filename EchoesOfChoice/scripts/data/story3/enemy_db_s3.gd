...
static func create_dream_wisp(n: String, lvl: int = 1) -> FighterData:
	...
	f.health = _es(58, 70, 3, 5, lvl, 1); f.max_health = f.health
	f.mana = _es(16, 22, 2, 3, lvl, 1); f.max_mana = f.mana
	f.physical_attack = _es(14, 18, 1, 2, lvl, 1)
	f.physical_defense = _es(8, 12, 1, 2, lvl, 1)
	f.magic_attack = _es(24, 30, 2, 3, lvl, 1)
	f.magic_defense = _es(14, 18, 1, 2, lvl, 1)
	f.speed = _es(26, 31, 2, 3, lvl, 1)
...
static func create_phantasm(n: String, lvl: int = 1) -> FighterData:
	...
	f.health = _es(65, 78, 3, 5, lvl, 1); f.max_health = f.health
	f.mana = _es(14, 18, 1, 3, lvl, 1); f.max_mana = f.mana
	f.physical_attack = _es(20, 25, 1, 3, lvl, 1)
	f.physical_defense = _es(10, 14, 1, 2, lvl, 1)
	f.magic_attack = _es(18, 23, 1, 3, lvl, 1)
	f.magic_defense = _es(13, 17, 1, 2, lvl, 1)
	f.speed = _es(24, 29, 1, 3, lvl, 1)
...
static func create_shade_moth(n: String, lvl: int = 1) -> FighterData:
	...
	f.health = _es(46, 58, 3, 4, lvl, 1); f.max_health = f.health
	f.mana = _es(10, 16, 1, 2, lvl, 1); f.max_mana = f.mana
	f.physical_attack = _es(17, 22, 1, 3, lvl, 1)
	f.physical_defense = _es(7, 11, 1, 2, lvl, 1)
	f.magic_attack = _es(14, 18, 1, 2, lvl, 1)
	f.magic_defense = _es(10, 14, 1, 2, lvl, 1)
	f.speed = _es(30, 36, 2, 3, lvl, 1)
...
static func create_slumber_beast(n: String, lvl: int = 2) -> FighterData:
	...
	f.health = _es(100, 118, 5, 8, lvl, 2); f.max_health = f.health
	f.mana = _es(10, 16, 1, 2, lvl, 2); f.max_mana = f.mana
	f.physical_attack = _es(28, 35, 2, 3, lvl, 2)
	f.physical_defense = _es(18, 23, 1, 3, lvl, 2)
	f.magic_attack = _es(10, 14, 1, 2, lvl, 2)
	f.magic_defense = _es(13, 18, 1, 2, lvl, 2)
...
static func create_fog_wraith(n: String, lvl: int = 2) -> FighterData:
	...
	f.health = _es(68, 82, 3, 5, lvl, 2); f.max_health = f.health
	f.mana = _es(18, 24, 2, 3, lvl, 2); f.max_mana = f.mana
	f.physical_attack = _es(14, 18, 1, 2, lvl, 2)
	f.physical_defense = _es(10, 14, 1, 2, lvl, 2)
	f.magic_attack = _es(28, 35, 2, 3, lvl, 2)
	f.magic_defense = _es(16, 21, 1, 2, lvl, 2)
...
static func create_sleep_stalker(n: String, lvl: int = 2) -> FighterData:
	...
	f.health = _es(76, 90, 4, 6, lvl, 2); f.max_health = f.health
	f.mana = _es(10, 16, 1, 2, lvl, 2); f.max_mana = f.mana
	f.physical_attack = _es(32, 38, 2, 3, lvl, 2)
	f.physical_defense = _es(12, 16, 1, 2, lvl, 2)
	f.magic_attack = _es(10, 14, 1, 2, lvl, 2)
	f.magic_defense = _es(12, 16, 1, 2, lvl, 2)
	f.speed = _es(28, 33, 2, 3, lvl, 2)
...
static func create_mirror_shade(n: String, lvl: int = 2) -> FighterData:
	...
	f.health = _es(72, 86, 3, 5, lvl, 2); f.max_health = f.health
	f.mana = _es(14, 18, 1, 2, lvl, 2); f.max_mana = f.mana
	f.physical_attack = _es(22, 27, 1, 3, lvl, 2)
	f.physical_defense = _es(15, 20, 1, 2, lvl, 2)
	f.magic_attack = _es(22, 27, 1, 3, lvl, 2)
	f.magic_defense = _es(15, 20, 1, 2, lvl, 2)
	f.speed = _es(24, 30, 1, 3, lvl, 2)
...
static func create_thorn_dreamer(n: String, lvl: int = 2) -> FighterData:
	...
	f.health = _es(86, 102, 4, 6, lvl, 2); f.max_health = f.health
	f.mana = _es(16, 22, 2, 3, lvl, 2); f.max_mana = f.mana
	f.physical_attack = _es(24, 29, 1, 3, lvl, 2)
	f.physical_defense = _es(14, 18, 1, 2, lvl, 2)
	f.magic_attack = _es(17, 22, 1, 2, lvl, 2)
	f.magic_defense = _es(15, 20, 1, 2, lvl, 2)
...
static func create_nightmare_hound(n: String, lvl: int = 4) -> FighterData:
	...
	f.health = _es(105, 122, 5, 8, lvl, 4); f.max_health = f.health
	f.mana = _es(10, 14, 1, 2, lvl, 4); f.max_mana = f.mana
	f.physical_attack = _es(26, 30, 2, 3, lvl, 4)
	f.physical_defense = _es(15, 18, 1, 2, lvl, 4)
	f.magic_attack = _es(12, 15, 1, 2, lvl, 4)
	f.magic_defense = _es(14, 17, 1, 2, lvl, 4)
	f.speed = _es(30, 35, 2, 3, lvl, 4)
...
static func create_dream_weaver(n: String, lvl: int = 4) -> FighterData:
	...
	f.health = _es(95, 112, 4, 7, lvl, 4); f.max_health = f.health
	f.mana = _es(16, 20, 2, 3, lvl, 4); f.max_mana = f.mana
	f.physical_attack = _es(12, 15, 1, 2, lvl, 4)
	f.physical_defense = _es(14, 17, 1, 2, lvl, 4)
	f.magic_attack = _es(26, 30, 2, 3, lvl, 4)
	f.magic_defense = _es(16, 19, 1, 2, lvl, 4)
	f.speed = _es(27, 32, 1, 3, lvl, 4)
...
static func create_somnolent_serpent(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(170, 196, 6, 9, lvl, 5); f.max_health = f.health
	f.mana = _es(14, 18, 1, 3, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(34, 40, 2, 3, lvl, 5)
	f.physical_defense = _es(22, 27, 1, 3, lvl, 5)
	f.magic_attack = _es(20, 24, 1, 2, lvl, 5)
	f.magic_defense = _es(20, 24, 1, 2, lvl, 5)
	f.speed = _es(28, 33, 1, 3, lvl, 5)
	f.crit_chance = 12; f.crit_damage = 1; f.dodge_chance = 12
...
static func create_twilight_stalker(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(162, 187, 5, 8, lvl, 5); f.max_health = f.health
	f.mana = _es(10, 14, 1, 2, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(40, 46, 2, 4, lvl, 5)
	f.physical_defense = _es(20, 24, 1, 2, lvl, 5)
	f.magic_attack = _es(16, 20, 1, 2, lvl, 5)
	f.magic_defense = _es(18, 22, 1, 2, lvl, 5)
	f.speed = _es(33, 38, 2, 3, lvl, 5)
...
static func create_dusk_sentinel(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(204, 238, 7, 10, lvl, 5); f.max_health = f.health
	f.mana = _es(10, 14, 1, 2, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(34, 40, 2, 3, lvl, 5)
	f.physical_defense = _es(30, 36, 2, 3, lvl, 5)
	f.magic_attack = _es(12, 16, 1, 2, lvl, 5)
	f.magic_defense = _es(27, 33, 1, 3, lvl, 5)
...
static func create_hollow_echo(n: String, lvl: int = 4) -> FighterData:
	...
	f.health = _es(98, 115, 4, 6, lvl, 4); f.max_health = f.health
...
static func create_waking_terror(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(178, 204, 6, 8, lvl, 5); f.max_health = f.health
	f.mana = _es(18, 22, 2, 4, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(20, 24, 1, 2, lvl, 5)
	f.physical_defense = _es(22, 26, 1, 2, lvl, 5)
	f.magic_attack = _es(38, 44, 2, 3, lvl, 5)
	f.magic_defense = _es(24, 28, 1, 2, lvl, 5)
	f.speed = _es(26, 31, 1, 3, lvl, 5)
	f.crit_chance = 12; f.crit_damage = 1; f.dodge_chance = 10
...
static func create_clock_specter(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(162, 187, 5, 8, lvl, 5); f.max_health = f.health
	f.mana = _es(14, 18, 1, 3, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(27, 33, 1, 3, lvl, 5)
	f.physical_defense = _es(20, 24, 1, 2, lvl, 5)
	f.magic_attack = _es(30, 36, 2, 3, lvl, 5)
	f.magic_defense = _es(20, 24, 1, 2, lvl, 5)
	f.speed = _es(30, 35, 2, 3, lvl, 5)
...
static func create_the_nightmare(n: String, lvl: int = 6) -> FighterData:
	...
	f.health = _es(290, 340, 8, 12, lvl, 6); f.max_health = f.health
	f.mana = _es(22, 26, 2, 4, lvl, 6); f.max_mana = f.mana
	f.physical_attack = _es(44, 50, 2, 4, lvl, 6)
	f.physical_defense = _es(28, 34, 2, 3, lvl, 6)
	f.magic_attack = _es(42, 48, 2, 4, lvl, 6)
	f.magic_defense = _es(28, 34, 2, 3, lvl, 6)
	f.speed = _es(34, 39, 2, 3, lvl, 6)
