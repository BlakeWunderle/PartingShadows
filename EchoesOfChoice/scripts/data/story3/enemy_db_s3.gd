...
static func create_dream_wisp(n: String, lvl: int = 1) -> FighterData:
	...
	f.mana = _es(10, 14, 1, 3, lvl, 1); f.max_mana = f.mana
...
static func create_phantasm(n: String, lvl: int = 1) -> FighterData:
	...
	f.physical_attack = _es(12, 15, 1, 2, lvl, 1)
	f.physical_defense = _es(6, 9, 0, 1, lvl, 1)
	f.magic_attack = _es(11, 14, 1, 2, lvl, 1)
	f.magic_defense = _es(8, 11, 1, 2, lvl, 1)
	f.speed = _es(22, 27, 1, 3, lvl, 1)
...
static func create_shade_moth(n: String, lvl: int = 1) -> FighterData:
	...
	f.health = _es(25, 33, 2, 3, lvl, 1); f.max_health = f.health
	f.mana = _es(6, 10, 1, 2, lvl, 1); f.max_mana = f.mana
	f.physical_attack = _es(10, 13, 1, 2, lvl, 1)
	f.physical_defense = _es(4, 7, 0, 1, lvl, 1)
	f.magic_attack = _es(8, 11, 0, 2, lvl, 1)
	f.magic_defense = _es(6, 9, 0, 1, lvl, 1)
	f.speed = _es(26, 32, 1, 3, lvl, 1)
...
static func create_sleep_stalker(n: String, lvl: int = 2) -> FighterData:
	...
	f.mana = _es(6, 10, 1, 2, lvl, 2); f.max_mana = f.mana
	f.physical_attack = _es(18, 22, 1, 3, lvl, 2)
...
static func create_mirror_shade(n: String, lvl: int = 2) -> FighterData:
	...
	f.physical_attack = _es(13, 16, 1, 2, lvl, 2)
...
static func create_thorn_dreamer(n: String, lvl: int = 2) -> FighterData:
	...
	f.physical_attack = _es(14, 17, 1, 2, lvl, 2)
	f.physical_defense = _es(8, 11, 1, 2, lvl, 2)
	f.magic_attack = _es(10, 13, 1, 2, lvl, 2)
	f.magic_defense = _es(9, 12, 1, 2, lvl, 2)
...
static func create_dream_weaver(n: String, lvl: int = 4) -> FighterData:
	...
	f.health = _es(80, 95, 3, 6, lvl, 4); f.max_health = f.health
...
static func create_somnolent_serpent(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(100, 115, 4, 6, lvl, 5); f.max_health = f.health
	f.mana = _es(10, 14, 1, 3, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(20, 24, 1, 3, lvl, 5)
	f.physical_defense = _es(14, 17, 1, 2, lvl, 5)
	f.magic_attack = _es(12, 15, 1, 2, lvl, 5)
	f.magic_defense = _es(13, 16, 1, 2, lvl, 5)
...
static func create_twilight_stalker(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(95, 110, 3, 6, lvl, 5); f.max_health = f.health
	...
	f.crit_chance = 18; f.crit_damage = 2; f.dodge_chance = 15
...
static func create_dusk_sentinel(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(120, 140, 5, 8, lvl, 5); f.max_health = f.health
	f.mana = _es(8, 12, 1, 2, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(20, 24, 1, 3, lvl, 5)
	f.physical_defense = _es(18, 22, 1, 3, lvl, 5)
	f.magic_attack = _es(8, 11, 0, 1, lvl, 5)
	f.magic_defense = _es(16, 20, 1, 2, lvl, 5)
	f.speed = _es(22, 27, 1, 2, lvl, 5)
	f.crit_chance = 8; f.crit_damage = 1; f.dodge_chance = 5
...
static func create_hollow_echo(n: String, lvl: int = 4) -> FighterData:
	...
	f.health = _es(85, 100, 3, 5, lvl, 4); f.max_health = f.health
...
static func create_waking_terror(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(105, 120, 4, 6, lvl, 5); f.max_health = f.health
	f.mana = _es(14, 18, 2, 3, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(12, 15, 0, 2, lvl, 5)
...
static func create_clock_specter(n: String, lvl: int = 5) -> FighterData:
	...
	f.health = _es(95, 110, 3, 6, lvl, 5); f.max_health = f.health
	f.mana = _es(10, 14, 1, 3, lvl, 5); f.max_mana = f.mana
	f.physical_attack = _es(16, 20, 1, 2, lvl, 5)
	f.physical_defense = _es(12, 15, 1, 2, lvl, 5)
	f.magic_attack = _es(18, 22, 1, 3, lvl, 5)
	f.magic_defense = _es(13, 16, 1, 2, lvl, 5)
...
static func create_the_nightmare(n: String, lvl: int = 6) -> FighterData:
	...
	f.health = _es(180, 210, 6, 10, lvl, 6); f.max_health = f.health
	f.mana = _es(18, 22, 2, 4, lvl, 6); f.max_mana = f.mana
	f.physical_attack = _es(28, 32, 2, 3, lvl, 6)
	f.physical_defense = _es(18, 22, 1, 3, lvl, 6)
	f.magic_attack = _es(26, 30, 2, 3, lvl, 6)
	f.magic_defense = _es(18, 22, 1, 3, lvl, 6)
	f.speed = _es(30, 35, 2, 3, lvl, 6)
