...
static func create_lucid_phantom(n: String, lvl: int = 7) -> FighterData:
	...
	f.health = _es(165, 190, 5, 8, lvl, 7); f.max_health = f.health
	f.mana = _es(14, 18, 1, 3, lvl, 7); f.max_mana = f.mana
	f.physical_attack = _es(18, 22, 1, 2, lvl, 7)
	f.physical_defense = _es(20, 24, 1, 2, lvl, 7)
	f.magic_attack = _es(30, 34, 2, 3, lvl, 7)
	f.magic_defense = _es(22, 26, 1, 3, lvl, 7)
	f.speed = _es(32, 37, 1, 3, lvl, 7)
	f.crit_chance = 12; f.crit_damage = 1; f.dodge_chance = 15
...
static func create_thread_spinner(n: String, lvl: int = 7) -> FighterData:
	...
	f.health = _es(170, 195, 5, 8, lvl, 7); f.max_health = f.health
	f.mana = _es(16, 20, 2, 3, lvl, 7); f.max_mana = f.mana
	f.physical_attack = _es(16, 20, 1, 2, lvl, 7)
	f.physical_defense = _es(22, 26, 1, 3, lvl, 7)
	f.magic_attack = _es(24, 28, 1, 3, lvl, 7)
	f.magic_defense = _es(24, 28, 1, 3, lvl, 7)
...
static func create_loom_sentinel(n: String, lvl: int = 8) -> FighterData:
	...
	f.health = _es(200, 230, 6, 10, lvl, 8); f.max_health = f.health
	f.mana = _es(10, 14, 1, 2, lvl, 8); f.max_mana = f.mana
	f.physical_attack = _es(30, 34, 2, 3, lvl, 8)
	f.physical_defense = _es(26, 30, 2, 3, lvl, 8)
	f.magic_attack = _es(14, 18, 1, 2, lvl, 8)
	f.magic_defense = _es(24, 28, 1, 3, lvl, 8)
	f.speed = _es(26, 31, 1, 2, lvl, 8)
...
static func create_cult_shade(n: String, lvl: int = 7) -> FighterData:
	...
	f.health = _es(160, 185, 4, 7, lvl, 7); f.max_health = f.health
	f.mana = _es(16, 20, 2, 3, lvl, 7); f.max_mana = f.mana
	f.physical_attack = _es(14, 18, 1, 2, lvl, 7)
	f.physical_defense = _es(18, 22, 1, 2, lvl, 7)
	f.magic_attack = _es(32, 36, 2, 3, lvl, 7)
	f.magic_defense = _es(20, 24, 1, 2, lvl, 7)
...
static func create_dream_warden(n: String, lvl: int = 8) -> FighterData:
	...
	f.health = _es(185, 210, 5, 8, lvl, 8); f.max_health = f.health
	f.mana = _es(12, 16, 1, 3, lvl, 8); f.max_mana = f.mana
	f.physical_attack = _es(24, 28, 1, 3, lvl, 8)
	f.physical_defense = _es(24, 28, 2, 3, lvl, 8)
	f.magic_attack = _es(28, 32, 1, 3, lvl, 8)
	f.magic_defense = _es(22, 26, 1, 3, lvl, 8)
...
static func create_thought_leech(n: String, lvl: int = 8) -> FighterData:
	...
	f.health = _es(170, 195, 4, 7, lvl, 8); f.max_health = f.health
	f.mana = _es(16, 20, 2, 3, lvl, 8); f.max_mana = f.mana
	f.physical_attack = _es(14, 18, 1, 2, lvl, 8)
	f.physical_defense = _es(18, 22, 1, 2, lvl, 8)
	f.magic_attack = _es(30, 34, 2, 3, lvl, 8)
	f.magic_defense = _es(22, 26, 1, 3, lvl, 8)
...
static func create_void_spinner(n: String, lvl: int = 8) -> FighterData:
	...
	f.health = _es(175, 200, 5, 7, lvl, 8); f.max_health = f.health
	f.mana = _es(18, 22, 2, 3, lvl, 8); f.max_mana = f.mana
	f.physical_attack = _es(12, 16, 0, 2, lvl, 8)
	f.physical_defense = _es(20, 24, 1, 2, lvl, 8)
	f.magic_attack = _es(32, 36, 2, 3, lvl, 8)
	f.magic_defense = _es(24, 28, 1, 3, lvl, 8)
...
static func create_sanctum_guardian(n: String, lvl: int = 9) -> FighterData:
	...
	f.health = _es(260, 300, 8, 12, lvl, 9); f.max_health = f.health
	f.mana = _es(20, 24, 2, 4, lvl, 9); f.max_mana = f.mana
	f.physical_attack = _es(34, 38, 2, 3, lvl, 9)
	f.physical_defense = _es(26, 30, 2, 3, lvl, 9)
	f.magic_attack = _es(34, 38, 2, 3, lvl, 9)
	f.magic_defense = _es(26, 30, 2, 3, lvl, 9)
	f.speed = _es(34, 39, 2, 3, lvl, 9)
